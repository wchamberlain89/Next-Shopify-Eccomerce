...
const storefontAccessToken = process.env.SHOPIFY_STOREFRONT_ACCESSTOKEN
...
async function ShopifyData(query) {
  ...
  const options = {
    ...
    method: "POST",
    headers: {
      "X-Shopify-Storefront-Access-Token": storefontAccessToken,
  ...
  try {
    ...
    console.log(data, "data in shopify data")
    return data
  } catch (error) {
...
export async function createCheckout(id, quantity) {
  ...
  `
  console.log('createCheckout arguments ', id, quantity)
  
  const response = await ShopifyData(query)
  console.log('response in createCheckout', response)
...
export async function updateCheckout(checkoutId, lineItems){
  ...
  console.log(lineItemsObject, ' lineItems Object')
  ...
  console.log('data in updatecheckout', response)
